...
import com.ragg.innertube.models.WatchEndpoint.WatchEndpointMusicSupportedConfigs.WatchEndpointMusicConfig.Companion.MUSIC_VIDEO_TYPE_OMV
...
data class MediaMetadata(
    ...
    fun toYTItem() = SongItem(
        id = id,
        title = title,
        artists = artists.map { com.ragg.innertube.models.Artist(name = it.name, id = it.id) },
        album = album?.let { com.ragg.innertube.models.Album(name = it.title, id = it.id) },
        duration = duration,
