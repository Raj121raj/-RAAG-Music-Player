...
import com.ragg.music.listentogether.ListenTogetherManager
import com.ragg.music.models.MediaMetadata
import com.ragg.music.playback.CastConnectionHandler
...
private fun NewMiniPlayer(
    ...
    var miniPlayerModifier = modifier
        .windowInsetsPadding(WindowInsets.systemBars.only(WindowInsetsSides.Horizontal))
        .padding(start = 16.dp, end = 16.dp, bottom = 12.dp)

    if (swipeThumbnail) {
        miniPlayerModifier = miniPlayerModifier.pointerInput(Unit) {
    ...
    com.ragg.music.ui.component.GlassSurface(
        ...
        Box(
            ...
            // Optional: faint album art blur behind the glass
            ...
            if (isListenTogetherGuest && isMuted ||
                ...
                Box(
                    modifier =
                        Modifier
                            .fillMaxSize()
                            .background(Color(0xFF1E1B2E).copy(alpha = 0.5f), CircleShape),
                )
                Icon(
                    painter =
                        painterResource(
