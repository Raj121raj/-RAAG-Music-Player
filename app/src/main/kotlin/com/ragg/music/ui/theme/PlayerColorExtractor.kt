...
/**
 * Extension function to extract a suitable theme color from a bitmap
 * Used for dynamic UI skinning based on album art
 */
fun Bitmap.extractThemeColor(): Color {
    ...
    return swatch?.rgb?.let { Color(it) } ?: Color(0xFF8B5CF6)
}
