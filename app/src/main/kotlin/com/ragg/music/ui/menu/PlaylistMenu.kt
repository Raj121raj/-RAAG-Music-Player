...
import com.ragg.music.ui.menu.ExportDialog
import com.ragg.music.utils.PlaylistExporter
    ...
    if (showExportDialog) {
        ExportDialog(
            ...
            onShare = { format ->
                val playlistSongs =
                    songs.map { s ->
                        com.ragg.music.db.entities.PlaylistSong(
                            map =
                                com.ragg.music.db.entities.PlaylistSongMap(
                                    songId = s.id,
