...
package com.ragg.music.listentogether
...
import com.ragg.music.constants.ListenTogetherIsHostKey
import com.ragg.music.constants.ListenTogetherRoomCodeKey
import com.ragg.music.constants.ListenTogetherServerUrlKey
import com.ragg.music.constants.ListenTogetherSessionTimestampKey
import com.ragg.music.constants.ListenTogetherSessionTokenKey
import com.ragg.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        companion object {
            ...
            const val ACTION_APPROVE_JOIN = "com.ragg.music.LISTEN_TOGETHER_APPROVE_JOIN"
            const val ACTION_REJECT_JOIN = "com.ragg.music.LISTEN_TOGETHER_REJECT_JOIN"
            const val ACTION_APPROVE_SUGGESTION = "com.ragg.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
            const val ACTION_REJECT_SUGGESTION = "com.ragg.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
        ...
        private fun loadBlockedUsernames() {
            try {
                val blockedJson = context.dataStore.get(com.ragg.music.constants.ListenTogetherBlockedUsersKey, "")
                val blockedList =
        ...
        private suspend fun saveBlockedUsernames() {
            try {
                ...
                context.dataStore.edit { preferences ->
                    preferences[com.ragg.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
                }
            } catch (e: Exception) {
