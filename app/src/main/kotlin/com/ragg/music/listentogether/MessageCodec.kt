...
import com.ragg.music.listentogether.proto.Listentogether
...
class MessageCodec(
    ...
    private fun protoToRoomState(proto: Listentogether.RoomState): RoomState {
        val users = proto.usersList.map { protoToUserInfo(it as Listentogether.UserInfo) }
        val queue = proto.queueList.map { protoToTrackInfo(it as Listentogether.TrackInfo) }
