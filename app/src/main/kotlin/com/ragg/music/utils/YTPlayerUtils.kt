...
package com.ragg.music.utils

import android.net.ConnectivityManager
import android.net.Uri
import android.util.Log
import androidx.media3.common.PlaybackException
import com.ragg.innertube.NewPipeExtractor
import com.ragg.innertube.YouTube
import com.ragg.innertube.models.YouTubeClient
import com.ragg.innertube.models.YouTubeClient.Companion.ANDROID_CREATOR
import com.ragg.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_43_32
import com.ragg.innertube.models.YouTubeClient.Companion.ANDROID_VR_1_61_48
import com.ragg.innertube.models.YouTubeClient.Companion.ANDROID_VR_NO_AUTH
import com.ragg.innertube.models.YouTubeClient.Companion.IOS
import com.ragg.innertube.models.YouTubeClient.Companion.IPADOS
import com.ragg.innertube.models.YouTubeClient.Companion.MOBILE
import com.ragg.innertube.models.YouTubeClient.Companion.TVHTML5
import com.ragg.innertube.models.YouTubeClient.Companion.TVHTML5_SIMPLY_EMBEDDED_PLAYER
import com.ragg.innertube.models.YouTubeClient.Companion.WEB
import com.ragg.innertube.models.YouTubeClient.Companion.WEB_CREATOR
import com.ragg.innertube.models.YouTubeClient.Companion.WEB_REMIX
import com.ragg.innertube.models.WatchEndpoint.WatchEndpointMusicSupportedConfigs.WatchEndpointMusicConfig.Companion.MUSIC_VIDEO_TYPE_PRIVATELY_OWNED_TRACK
import com.ragg.innertube.models.response.PlayerResponse
import com.ragg.music.constants.AudioQuality
import com.ragg.music.utils.cipher.CipherDeobfuscator
import com.ragg.music.utils.YTPlayerUtils.MAIN_CLIENT
import com.ragg.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.ragg.music.utils.YTPlayerUtils.validateStatus
import com.ragg.music.utils.potoken.PoTokenGenerator
import com.ragg.music.utils.potoken.PoTokenResult
import com.ragg.music.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
                    ...
                    try {
                        ...
                        if (originalUrl == streamUrl && skipNewPipe) {
                            ...
                            try {
                                ...
                                com.ragg.innertube.NewPipeUtils
                                val newPipeUrl = com.ragg.innertube.NewPipeExtractor.getThrottlingDeobfuscatedUrl(videoId, streamUrl)
    ...
    private fun getSignatureTimestampOrNull(videoId: String): SignatureTimestampResult {
        ...
        com.ragg.innertube.NewPipeUtils  // Ensure NewPipe downloader is initialized before use
