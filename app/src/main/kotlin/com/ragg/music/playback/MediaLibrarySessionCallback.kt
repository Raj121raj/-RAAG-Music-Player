...
import com.ragg.music.constants.AndroidAutoSectionsOrderKey
import com.ragg.music.constants.AndroidAutoYouTubePlaylistsKey
import com.ragg.music.ui.screens.settings.AndroidAutoSection
import com.ragg.music.ui.screens.settings.deserializeSections
import com.ragg.music.ui.screens.settings.serializeSections
                ...
                when (parentId) {
                    ...
                    MusicService.YOUTUBE_PLAYLIST -> {
                        if (!context.dataStore.get(AndroidAutoYouTubePlaylistsKey, false)) {
                            ...
                            try {
                                val allSections = mutableListOf<com.ragg.innertube.pages.HomePage.Section>()
