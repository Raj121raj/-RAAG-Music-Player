...
val baseApplicationId = "com.ragg.music"
val applicationIdOverride = System.getenv("RAAG_APPLICATION_ID")?.takeIf { it.isNotBlank() }
val appNameOverride = System.getenv("RAAG_APP_NAME")?.takeIf { it.isNotBlank() }
val debugKeystorePathOverride = System.getenv("RAAG_DEBUG_KEYSTORE_PATH")?.takeIf { it.isNotBlank() }
val debugKeystorePassword = System.getenv("RAAG_DEBUG_KEYSTORE_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
val debugKeyAlias = System.getenv("RAAG_DEBUG_KEY_ALIAS")?.takeIf { it.isNotBlank() } ?: "androiddebugkey"
val debugKeyPassword = System.getenv("RAAG_DEBUG_KEY_PASSWORD")?.takeIf { it.isNotBlank() } ?: "android"
...
android {
    ...
    defaultConfig {
        ...
        targetSdk = 36
        versionCode = 146
        versionName = "RAAG-2026.1"
        resValue("string", "app_name", appNameOverride ?: "RAAG")
