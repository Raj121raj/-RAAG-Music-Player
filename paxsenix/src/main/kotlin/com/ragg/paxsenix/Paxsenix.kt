package com.ragg.paxsenix

import android.content.Context
import com.ragg.music.betterlyrics.TTMLParser
import com.ragg.paxsenix.models.LyricsResponse
import com.ragg.paxsenix.models.SearchResponse
import com.ragg.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "RAAG/$appVersion")
                }
